...
const Icon = ({ name, size = 16, stroke = 1.6 }) => {
  ...
  const paths = {
    ...
    brain: <><path d="M8 4a2 2 0 0 0-2 2 2 2 0 0 0-2 2v1a2 2 0 0 0 1 1.7V14a2 2 0 0 0 2 2h1v-12Z" /><path d="M12 4a2 2 0 0 1 2 2 2 2 0 0 1 2 2v1a2 2 0 0 1-1 1.7V14a2 2 0 0 1-2 2h-1v-12Z" /></>,
    database: <><ellipse cx="10" cy="5" rx="6" ry="2" /><path d="M4 5v5c0 1 3 2 6 2s6-1 6-2V5" /><path d="M4 10v5c0 1 3 2 6 2s6-1 6-2v-5" /></>,
  };
  return (
